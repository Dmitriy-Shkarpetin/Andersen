...
//        Stream<Integer> stream1 = Stream.of(1, 22, 3, 54, 5, 6, 202, 66, 89);
//        stream1.filter(el ->
//        {
//            System.out.println("!!!");
//            return el%2==0;
...
//        System.out.println(stream5.distinct().count());
        System.out.println(stream5.distinct().peek(System.out::println).count()); //помогает посмотреть что происходит на разных этапах метод-чейнинга
